...
| Services and Networking | *1.* Demonstrate basic understanding of NetworkPolicies + Provide and troubleshoot access to applications via services *3.* Use Ingress rules to expose applications | 20 |
